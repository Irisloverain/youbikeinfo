...
export default function Home() {
  ...
  return (
    ...
    <div className='container'>
      <h4 className='f-LightGreen my-4'>站點資訊</h4>
      <SelectArea 
      AreaList={AreaList}
      ...
      query={query}
      setQuery={setQuery} ></SelectArea>
      <div>
    </div>
      <table className='w-100 youbike-table'>
      <thead>
        <tr>
          <th className='border-left-28'>縣市</th>
          <th>區域</th>
          <th>站點名稱</th>
          <th>可借車輛</th>
          <th className='border-right-28'>可選空位</th>
        </tr>
      </thead>
      <tbody>
      {youbikes.map((station) => (
          <tr key={station.sno}>
          <td>台北市</td>
          <td>{station.sarea}</td>
          <td>{station.sna}</td>
